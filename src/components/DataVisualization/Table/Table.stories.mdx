...
<Meta
  ...
  argTypes = {{
    ...
    rows: {
      ...
      defaultValue: [
        ...
        [
          ...
          { value: '22', },
          { value: ['54.577.985/0001-90', '54.577.985/0001-90', '54.577.985/0001-90', '54.577.985/0001-90'] },
        ...
        [
          { value: 'Alfredo', secondaryValue: '123.456.789-10' },
          { value: '20' },
          { value: ['33.237.930/8965-90', '54.577.985/0001-90'] },
          { value: 'https://s3-sa-east-1.amazonaws.com/adapcon-pro-production-customer/script-financeiro/bacen-237.png' },
          { badges: [{ value: 'Finalizado', backgroundColor: 'success-light', fontColor: 'success', size: 'pb-md' }] },
        ...
        [
          { value: 'Silva', secondaryValue: '661.313.649-23' },
          { value: '22', },
          { value: ['33.237.930/8965-90', '54.577.985/0001-90'] },
          { value: 'https://s3-sa-east-1.amazonaws.com/adapcon-pro-production-customer/script-financeiro/bacen-341.png' },
          { badges: [{ value: 'Finalizado', backgroundColor: 'success-light', fontColor: 'success', size: 'pb-md' }] },
        ...
        [
          { value: 'Gael', secondaryValue: '898.372.281-30' },
          { value: '16', },
          { value: ['33.237.930/8965-90', '54.577.985/0001-90'] },
          { value: 'Não informado', badges: [{ value: 'menor de idade' }] },
          { badges: [{ value: 'Finalizado', backgroundColor: 'success-light', fontColor: 'success', size: 'pb-md' }] },
        ...
        [
          { value: 'Gomes da Silva Mendes de Souza', secondaryValue: '398.722.811-30' },
          { value: '23', },
          { value: ['33.237.930/8965-90', '54.577.985/0001-90'] },
          { value: 'Sem preferência' },
          { badges: [{ value: 'Finalizado', backgroundColor: 'success-light', fontColor: 'success', size: 'pb-md' }] },
        ...
        [
          { value: 'Oliveira', secondaryValue: '898.372.281-30' },
          { value: '11', },
          { value: ['33.237.930/8965-90', '54.577.985/0001-90'] },
          { value: 'Não informado', badges: [{ value: 'menor de idade'}, { value: '<12' }] },
          { badges: [{ value: 'Finalizado', backgroundColor: 'success-light', fontColor: 'success', size: 'pb-md' }] },
    ...
    count: { type: Number, defaultValue: 16 },
    pageLimit: { type: Number, defaultValue: 5 },
    hasPagination: { type: 'boolean', defaultValue: true },
    currentPage: { type: Number, defaultValue: 0 },
    useInternalSort: { type: 'boolean', defaultValue: true },
  }}
/>
...
export const Template = (args, { argTypes }) => ({
  ...
  template: `
    <div style="background-color: white;">
      <PbTable
        ...
        :current-page="page"
        :use-internal-sort="useInternalSort"
        @change-page="pg => { pageRows = rows.slice(pg * pageLimit, (pg * pageLimit) + pageLimit); page = pg }"
      >
  ...
  data() {
    return {
      pageRows: this.rows.slice(0, this.pageLimit),
...
export const TemplateWithInitialSort = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  components: { PbTable },
  template: `
    <div style="background-color: white;">
...
| useInternalSort             | Boolean     | true    | It sets if the Table component will do the intern filter or just emit the sort event.                    |
| initialSort                 | Object      | {columnIndex: number, type: 'asc' \| 'desc'}     | It define if the Table component will start with a sorted column.                    |
| hasSearchIcon               | Boolean     | true    | Allows to enable or disable the Search Input icon.                                                       |
...
| search-input                | String      | On change data in searchinput      | Emits the search term every time it changes                                   |
| clear-input                 |             | Clean the search input             | Emits that search input has been cleared                                      |
| sort                        | {columnIndex: number, type: 'asc' \| 'desc'} | Emits the sort | Emits when user click on some table header|
...
<Canvas>
  <Story name="With Initial Sort" height="auto" args={{ initialSort: { columnIndex: 0, type: 'asc' } }}>
    { TemplateWithInitialSort.bind({}) }
  </Story>
</Canvas>
